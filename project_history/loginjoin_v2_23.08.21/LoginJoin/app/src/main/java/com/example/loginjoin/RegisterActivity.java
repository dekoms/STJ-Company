...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //아이디값 찾아주기
        join_ID = findViewById(R.id.editId1);
        join_password = findViewById(R.id.editPwd);
        join_name = findViewById(R.id.editName);
        join_pwck = findViewById(R.id.editRepwd);
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success) {
                                ...
                                validate = true; //검증 완료
                                check_button.setBackgroundColor(Color.parseColor("#7a7978"));
                            }
                            else {
                                AlertDialog.Builder builder = new AlertDialog.Builder(RegisterActivity.this);
        ...
        //회원가입 버튼 클릭 시 수행
        join_button = findViewById( R.id.acceptJoin );
