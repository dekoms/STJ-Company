...
public class CustomDialog extends AlertDialog {
    ...
    public void run() {
        ...
        LinearLayout linearLayoutViewGroup = (LinearLayout) rootView.findViewById(R.id.custom_dialog_container);
        View view = LayoutInflater.from(rootView.getContext()).inflate(R.layout.layout_calendar_dialog, linearLayoutViewGroup);

        View view2 = LayoutInflater.from(rootView.getContext()).inflate(R.layout.layout_calendar_dialog,
                (ViewGroup) view, false);

        builder.setView(view2);

        TextView calendar_cell_dialog_title = (TextView) view2.findViewById(R.id.calendar_cell_dialog_title_background);
        EditText add_todo = (EditText) view2.findViewById(R.id.add_todo);
        Button insert_btn = (Button) view2.findViewById(R.id.insert_btn);
...
//다이얼로그 설정
        ...
        LinearLayout linearLayout = (LinearLayout) rootView.findViewById(R.id.layout_calendar_dialog);
        View view = LayoutInflater.from(rootView.getContext()).inflate(R.layout.layout_calendar_dialog, linearLayout);
